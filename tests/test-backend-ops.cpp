...
// Conv_2D test cases
 ...
 // A deep layer of a ConvNet, several images in the batch
    ...
    // Q8 MMA tile loading: partial tiles, strided caches, GQA and multiple sequences.
    for (int64_t hs : {64, 96, 128, 256}) {
        test_cases.emplace_back(new test_flash_attn_ext(hs, hs, 2, {3, 2}, 513, 65, true, true, 0, 0, GGML_PREC_F32, GGML_TYPE_Q8_0, GGML_TYPE_Q8_0, {0, 2, 1, 3}));
        test_cases.emplace_back(new test_flash_attn_ext(hs, hs, 2, {6, 1}, 512, 65, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_Q8_0, GGML_TYPE_Q8_0, {0, 2, 1, 3}));
    }
    test_cases.emplace_back(new test_flash_attn_ext(256, 256, 4, {6, 1}, 4096, 65, true, false, 0, 0, GGML_PREC_F32, GGML_TYPE_Q8_0, GGML_TYPE_Q8_0, {0, 2, 1, 3}));
