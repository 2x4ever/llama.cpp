...
| `--prefill-decode-ratio N` | number of decode-only batches before allowing a mixed prefill/decode batch (0 = disabled, default: 0)<br/>(env: LLAMA_ARG_PREFILL_DECODE_RATIO) |
